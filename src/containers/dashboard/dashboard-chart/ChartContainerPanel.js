...
import {DateRanges} from "./useDashBoardChartController";
import TVocChartNew from "./TVocChartNew";
import {useDashBoardNewChartController} from "./useDashBoardNewChartController";
...
const ChartContainerPanel = React.memo(function ChartContainerPanel({match, history}) {
    ...
    const {
        ...
        fieldNames,
        resourceNotFound,
    } = useDashBoardNewChartController({
        match,
        history,
    });
...
export default withRouter(ChartContainerPanel);
