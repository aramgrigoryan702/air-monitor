...
export  function useDashBoardChartController({match, history}) {
    ...
    React.useLayoutEffect(() => {
        try {
            ...
            let daysModeStr;
            //window.localStorage.getItem('daysMode');
            let selectedDateRangeStr;
            //= window.localStorage.getItem('selectedDateRange');
