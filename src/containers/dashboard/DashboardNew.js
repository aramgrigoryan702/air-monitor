...
import ChartContainerPanel from "./dashboard-chart/ChartContainerPanel";
...
const DashboardNew = React.memo(function DashboardNew(props) {
    ...
    const getActivatedRouteForDivisionSubTopic = (subTopic = "overview") => {
        ...
        switch (subTopic) {
            ...
            case 'data':
                ...
                break;
            default  :
                subTopicRef = (<Redirect to={`/dashboardnew/${topic}/${id}/overview`}/>);
        }
        return subTopicRef;
    };
    ...
    const getActivatedRouteForSiteSubTopic = (subTopic = "overview") => {
        ...
        switch (subTopic) {
            ...
            case 'analyze':
                //setSelectedPageName('linechart');
                subTopicRef = (<ChartContainerPanel containerType='site'/>);
                break;
            case 'data':
                // setSelectedPageName('devices');
    ...
    const getActivatedRout = (topic, subTopic) => {
        ...
        switch (topic) {
            ...
            case  'admin-tools':
                ...
                break;
            default  :
                topicRef = (<Redirect to={`/dashboardnew/global/devices/overview`}/>);
        }
        return topicRef;
    };
